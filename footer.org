...
<div class="footer">
  ...
  <table width="100%">
    <tbody>
      <tr>
        <td><small>Made with </small><a href="https://www.gnu.org/software/emacs/"><img src="static/EmacsSplashScreen.png" style="width:40px" alt="emacs"/></a><small> and </small><a href="https://orgmode.org/"><img src="static/org-mode-unicorn.png" style="width:35px" alt="org mode"/></a></td>
        <td><a href="http://www.anybrowser.org/campaign/"><img src="icons/anyweb-8831.png" alt="Viewable With Any Browser" /></a></td>
        ...
        <td><a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"    src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" /></a></td>
      </tr>
    </tbody>
  </table>
 <br />
